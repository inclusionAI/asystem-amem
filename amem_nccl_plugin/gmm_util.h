...
static volatile log_level_t gmm_log_level;
...
[[maybe_unused]] static thread_local FILE* gmm_log_file;
#define MODULE_STRING "AMEM "
#define gmm_logger(level, fp, format, ...)                                  \
  ({                                                                        \
    if (level <= gmm_log_level) {                                           \
      ...
      switch (level) {                                                      \
        case VERBOSE:                                                       \
          fprintf(gmm_log_fd, MODULE_STRING "[VERB] ");                                   \
          break;                                                            \
        case DEBUG:                                                         \
          fprintf(gmm_log_fd, MODULE_STRING "[DEBG] ");                                   \
          break;                                                            \
        case INFO:                                                          \
          fprintf(gmm_log_fd, MODULE_STRING "[INFO] ");                                   \
          break;                                                            \
        case WARN:                                                          \
          fprintf(gmm_log_fd, MODULE_STRING "[WARN] ");                                   \
          break;                                                            \
        case ERROR:                                                         \
          fprintf(gmm_log_fd, MODULE_STRING "[ERRO] ");                                   \
          break;                                                            \
        case FATAL:                                                         \
          fprintf(gmm_log_fd, MODULE_STRING "[FATAL] ");                                  \
          break;                                                            \
      }                                                                     \
